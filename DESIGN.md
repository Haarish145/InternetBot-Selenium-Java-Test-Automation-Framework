...
| --- | --- | --- | --- |
| Authentication | `LoginPage` | `LoginTest` | Valid login, invalid login, success message, logout |
| JavaScript Alerts | `AlertPage` | `AlertTest` | Alert accept, confirm dismiss, prompt text, result update |
| Checkbox and Dropdown | `CheckboxPage` | `CheckboxTest` | Checkbox selection, toggle, dropdown selection, option count |
| File Upload | `UploadPage` | `UploadTest` | Valid upload, page title, unsupported file upload handling |
| Dynamic Pages | `DynamicPage` | `DynamicTest` | Dynamic loading, loaded text, disappearing elements, dynamic content |
